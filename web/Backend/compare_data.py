...
from fsweb.models import Subjects
    ...
    def compare_volumes(self) -> list:
        ...
        for mn_st in self.mn_sts:
            for cmp_mn_st in self.cmp_mn_sts:
                compare_volumes.append(self.det_cmp_sts(mn_st.eTIV, cmp_mn_st.eTIV, mn_st.eTIV, cmp_mn_st.eTIV, "eTIV"))
                compare_volumes.append(
                ...
                compare_volumes.append(self.det_cmp_sts(mn_st.eTIV, cmp_mn_st.eTIV, mn_st.lhCerebralWhiteMatterVol,
                                              cmp_mn_st.lhCerebralWhiteMatterVol,
                                              "lhCerebralWhiteMatter"))
                compare_volumes.append(self.det_cmp_sts(mn_st.eTIV, cmp_mn_st.eTIV, mn_st.rhCerebralWhiteMatterVol,
                                              cmp_mn_st.rhCerebralWhiteMatterVol,
                                              "rhCerebralWhiteMatter"))
                compare_volumes.append(self.det_cmp_sts(mn_st.eTIV, cmp_mn_st.eTIV, mn_st.CerebralWhiteMatterVol,
                                              cmp_mn_st.CerebralWhiteMatterVol,
                                              "CerebralWhiteMatter"))
                compare_volumes.append(self.det_cmp_sts(mn_st.eTIV, cmp_mn_st.eTIV, mn_st.TotalGrayVol, cmp_mn_st.TotalGrayVol,
                                              "TotalGray"))
                compare_volumes.append(
